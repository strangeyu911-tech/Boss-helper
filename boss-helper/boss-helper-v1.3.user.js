...
(function() {
   ...
   *
   * 版本说明：
   * - 【新增】定时投递，支持设置每日投递时间，到点后自动启动投递
   * - 【新增】活跃状态筛选，支持按 HR 在线、刚刚活跃、今日活跃、3日内活跃控制投递范围
   * - 【新增】工作地址过滤，比城市过滤更精细，可以具体到区、街道、园区级别，支持正则表达式
   * - 【新增】自动投递支持跳过已收藏职位，避免重复投递已经标记过的岗位
   * - 【修复】投递统计计数逻辑，只有成功投递后才记录，避免跳过或失败的职位被计入统计
   * - 【修复】嵌套模态框关闭后页面滚动被错误恢复的问题
   * - 【优化】设置面板部分 UI 细节优化 ，提升显示稳定性
   */
    ...
    create() {
      ...
      this.panel.innerHTML = `
        ...
        <div class="bp-clean-settings-group">
          ...
          <div style="font-size: 12px; color: #6b7280; margin-top: 4px;">注：填写完整金额，如 15000</div>
        </div>
